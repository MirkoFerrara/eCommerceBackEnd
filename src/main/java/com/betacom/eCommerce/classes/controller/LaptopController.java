...
public class LaptopController {
    ...
    @GetMapping("/list")
    public Response<LaptopView> listAll(){
        Response<LaptopView> resp = new Response<LaptopView>();
        resp.setRc (true);
        try{
    ...
    @PostMapping("/update")
    public ResponseBase update(@RequestBody(required = true) LaptopRequest req){
        ResponseBase resp=new ResponseBase();
        resp.setRc(true);
        try {
            service.update(req);
